                    ...
                    <div class="row align-items-center py-4">
                        <div class="col-lg-6 col-7">
                            <h6 class="h2 text-white d-inline-block mb-0"><a
                                    href="{{ route('dashboard') }}">Dashboard</a></h6>
                            <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                                <ol class="breadcrumb breadcrumb-links breadcrumb-dark radius">
                                    ...
                                    <li class="breadcrumb-item"><a href="{{ route('attendance.index') }}">Kehadiran</a>
                                    </li>
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body text-center bg-white-100 radius shadow-2xl">
                            <h2 class="mt-4">Presensi Kehadiran : {{ $attendance->subject->name }} </h2>
                            <h3>Tanggal: {{ $attendance->date->format('D d, m, Y') }}</h3>
                            <p class="text-bold"> {{ $attendance->students->count() }} <i
                                    class="fas fa-users-class text-blue"></i></p>
                            <hr>
                            <div class="text-left">
                                <h2 class="mb-3 text-bold">Daftar Mahasiswa Peserta Mata Kuliah</h2>
                                <form action="{{ route('attendance.student.update', $attendance) }}" method="post">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-flush">
                                            ...
                                            <tr>
                                                <th scope="col" class="sort" data-sort="name">Nama Mahasiswa</th>
                                                <th scope="col" class="sort" data-sort="action">Keterangan</th>
                                            </tr>
                                            </thead>
                                            <tbody class="list">
