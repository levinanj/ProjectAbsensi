                ...
                <div class="header-body">
                    <div class="row align-items-center py-4">
                        <div class="col-lg-6 col-7">
                            <h6 class="h2 text-white d-inline-block mb-0"> <a href="{{ route('dashboard') }}">Dashboard</a></h6>
                        ...
                        <div class="col-lg-6 col-5 text-right">
                            <button class="btn btn-sm btn-neutral"  data-toggle="modal" data-target="#createAttendance"><i class="fas fa-plus mr-1"> </i> Tambah</button>
                ...
                <div class="col-12 mb-3">
                    <div class="card radius">
                        ...
                        <div class="card-header">
                            <h3 class="mb-0">Pencarian Berfilter</h3>
                        </div>
                        <!-- Card Body -->
                        <div class="card-body">
                            <form action="" id="form">
                            <div class="row">
                                <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="form-control-label" for="subject">Pilih Mata Kuliah</label>
                        ...
                        <div class="table-responsive">
                            <table class="table align-items-center table-flush datatable-buttons">
                                ...
                                <tr>
                                    ...
                                    <th scope="col" class="sort" data-sort="subject">Mata Kuliah</th>
                                    <th scope="col" class="sort" data-sort="teacher">Pengajar</th>
                                    <th scope="col" class="sort" data-sort="students">Jumlah Total Mahasiswa</th>
