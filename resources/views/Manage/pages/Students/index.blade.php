                ...
                <div class="header-body">
                    <div class="row align-items-center py-4">
                        ...
                        <div class="col-lg-6 col-5 text-right">
                            <button class="btn btn-sm btn-neutral"  data-toggle="modal" data-target="#createStudent"><i class="fas fa-plus mr-1"> </i> Tambah</button>
                    ...
                    <div class="card">
                        ...
                        <div class="table-responsive">
                            <table class="table align-items-center table-flush datatable-buttons">
                                ...
                                <tr>
                                    <th scope="col" class="sort" data-sort="employee">Nama</th>
                                    <th scope="col" class="sort" data-sort="employee">Email</th>
                                    <th scope="col" class="sort" data-sort="service">No. Telepon</th>
